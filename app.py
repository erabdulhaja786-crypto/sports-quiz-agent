...
st.write(
    ...
    "Powered by RAG (ChromaDB + Web Search)."
)
...
# Button to trigger the compilation pipeline
...
if st.session_state.quiz_output:
    ...
    st.info("Choose a sport and difficulty in the sidebar, then click **Generate Fresh Quiz**.")
